...
일정 이동 v42
-----------
- 상가리야자숲을 DAY 3에서 DAY 2로 이동
- DAY 2: 3번 시소 카이막 다음 4번 상가리야자숲으로 배치
- DAY 2의 기존 4번 이후 일정을 하나씩 뒤로 이동
- DAY 3의 상가리야자숲 제거 후 뒤 일정 번호를 하나씩 당김
- 놀거리 탭/상세 일정/패스 혜택 DAY 표기/지도 루트를 모두 동기화
